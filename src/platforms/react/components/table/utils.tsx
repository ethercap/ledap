...
export function getAntSubColumns(ledapColumns){
  return ledapColumns.map((column) => {
    return {
      hidden: column.visible === false,
      title: getTableTitle(column),
      dataIndex: column.attribute,
      key:column.attribute,
      render: typeof column.value == 'function' ? (val, item, index) => column.value(item, val, index) : null,
      ...column,
