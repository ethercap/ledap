(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		var a = typeof exports === 'object' ? factory(require("antd"), require("react"), require("react-dom")) : factory(root["antd"], root["react"], root["react-dom"]);
		for(var i in a) (typeof exports === 'object' ? exports : root)[i] = a[i];
	}
})(self, (__WEBPACK_EXTERNAL_MODULE__2059__, __WEBPACK_EXTERNAL_MODULE__9155__, __WEBPACK_EXTERNAL_MODULE__9514__) => {
...
module.exports = __WEBPACK_EXTERNAL_MODULE__2059__;
...
module.exports = __WEBPACK_EXTERNAL_MODULE__9514__;
...
__webpack_require__.d(__webpack_exports__, {
  ...
  Form: () => (/* reexport */ Form),
  FormContext: () => (/* reexport */ contexts_FormContext),
  FormItem: () => (/* reexport */ formItem_FormItem),
  FormItemContext: () => (/* reexport */ contexts_FormItemContext),
  FormItemLabel: () => (/* reexport */ formItem_FormItemLabel),
  FormValidateEvent: () => (/* reexport */ FormValidateEvent),
  Modal: () => (/* reexport */ modal_Modal),
  RadioGroup: () => (/* reexport */ RadioGroup),
  SearchInput: () => (/* reexport */ SearchInput),
  Segmented: () => (/* reexport */ Segmented),
  Select: () => (/* reexport */ Select),
  Table: () => (/* reexport */ Table),
  Uploader: () => (/* reexport */ uploader),
  useInputGroup: () => (/* reexport */ useInputGroup),
  useLedapModel: () => (/* reexport */ useLedapModel)
});
 ...
 * @returns 
 */function useLedapModel(model){var _useState=(0,external_react_.useState)(false),_useState2=_slicedToArray(_useState,2),bool=_useState2[0],setbool=_useState2[1];function _setValue(attr,val){model[attr]=val;setbool(function(bool){return!bool;});}function getValue(attr){return model[attr];}function updateView(){setbool(function(bool){return!bool;});}return{setValue:_setValue,getValue:getValue,updateView:updateView,model:model};}
...
var FormContext=/*#__PURE__*/(0,external_react_.createContext)({});/* harmony default export */ const contexts_FormContext = (FormContext);
;// ./src/platforms/react/components/formItem/FormItem.tsx
var FormItem_excluded=["FormComponent","model","attr","label","validate","children","antProps","dp","FormComponentProps"];function FormItem(props){var _props$FormComponent=props.FormComponent,FormComponent=_props$FormComponent===void 0?BaseInput:_props$FormComponent,propModel=props.model,attr=props.attr,label=props.label,validate=props.validate,children=props.children,_props$antProps=props.antProps,antProps=_props$antProps===void 0?{}:_props$antProps,dp=props.dp,FormComponentProps=props.FormComponentProps,reset=_objectWithoutProperties(props,FormItem_excluded);var _reset$labelCol=reset.labelCol,labelCol=_reset$labelCol===void 0?{span:8}:_reset$labelCol,_reset$wrapperCol=reset.wrapperCol,wrapperCol=_reset$wrapperCol===void 0?{span:16}:_reset$wrapperCol;var _ref=propModel?useLedapModel(propModel):(0,external_react_.useContext)(contexts_FormContext),setValue=_ref.setValue,getValue=_ref.getValue,updateView=_ref.updateView,model=_ref.model;var _setValue=function _setValue(val){setValue(attr,val);};var required=model===null||model===void 0?void 0:model.isRequired(attr);// console.log("render formItem:", {
//   attr,
//   value: model[attr],
//   hasError: model.hasErrors(attr),
//   error: model.getFirstError(attr),
// });
return/*#__PURE__*/external_react_default().createElement(contexts_FormItemContext.Provider,{value:{getValue:getValue,setValue:setValue}},/*#__PURE__*/external_react_default().createElement(external_antd_.Form.Item,_extends({className:classnames_default()(_1,{required:required}),label:label||(model===null||model===void 0?void 0:model.getAttributeLabel(attr)),labelCol:labelCol,wrapperCol:wrapperCol,validateStatus:model.hasErrors(attr)?"error":null,help:model.getFirstError(attr)},reset),/*#__PURE__*/external_react_default().createElement(FormComponent,_extends({model:model,attr:attr,validate:validate,onSetValue:_setValue,value:model[attr],onBlur:updateView,dp:dp},FormComponentProps)),children));}/* harmony default export */ const formItem_FormItem = (FormItem);
;// ./src/platforms/react/components/formItem/FormItemLabel.tsx
function FormItemLabel(props){var _props$labelComponent=props.labelComponent,labelComponent=_props$labelComponent===void 0?null:_props$labelComponent,_props$model=props.model,model=_props$model===void 0?null:_props$model,_props$attr=props.attr,attr=_props$attr===void 0?"":_props$attr,_props$label=props.label,label=_props$label===void 0?"":_props$label,className=props.className;return labelComponent?labelComponent:/*#__PURE__*/external_react_default().createElement("label",{className:classnames_default()(className)},label||(model===null||model===void 0?void 0:model.getAttributeLabel(attr)),model!==null&&model!==void 0&&model.isRequired(attr)?"*":"");}/* harmony default export */ const formItem_FormItemLabel = (FormItemLabel);
;// ./src/platforms/react/components/button/Button.tsx
function Button(props){return/*#__PURE__*/external_react_default().createElement(external_antd_.Button,props);}Button.Group=external_antd_.Button.Group;/* harmony default export */ const button_Button = (Button);
...
var Form_excluded=["model","className","inline","onFinish","enctype"];function ownKeys(e,r){var t=Object.keys(e);if(Object.getOwnPropertySymbols){var o=Object.getOwnPropertySymbols(e);r&&(o=o.filter(function(r){return Object.getOwnPropertyDescriptor(e,r).enumerable;})),t.push.apply(t,o);}return t;}function _objectSpread(e){for(var r=1;r<arguments.length;r++){var t=null!=arguments[r]?arguments[r]:{};r%2?ownKeys(Object(t),!0).forEach(function(r){_defineProperty(e,r,t[r]);}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(t)):ownKeys(Object(t)).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(t,r));});}return e;}function Form(props){var model=props.model,className=props.className,inline=props.inline,onFinish=props.onFinish,_props$enctype=props.enctype,enctype=_props$enctype===void 0?"application/json":_props$enctype,reset=_objectWithoutProperties(props,Form_excluded);var _useState=(0,external_react_.useState)(false),_useState2=_slicedToArray(_useState,2),bool=_useState2[0],setBool=_useState2[1];function getValue(attr){return model[attr];}function setValue(attr,val){model[attr]=val;setBool(function(bool){return!bool;});}function updateView(){setBool(function(bool){return!bool;});}function _onFinish(e){var json=_objectSpread({},model);var data=json;switch(enctype.toLocaleLowerCase()){case"multipart/form-data":{var formData=new FormData();Object.keys(json).forEach(function(key){if(json[key]===null){return;}formData.append(key,json[key]);});data=formData;break;}default:{break;}}// console.log("form on filish json:", data, json);
onFinish===null||onFinish===void 0||onFinish(data,json);}return/*#__PURE__*/external_react_default().createElement(contexts_FormContext.Provider,{value:{getValue:getValue,setValue:setValue,updateView:updateView,model:model}},/*#__PURE__*/external_react_default().createElement(external_antd_.Form,_extends({className:classnames_default()(form_module_1,className,inline&&"inline"),onFinish:_onFinish},reset),props.children));}
...
;// ./src/platforms/react/components/config-provider/configProvider.tsx
function configProvider_ownKeys(e,r){var t=Object.keys(e);if(Object.getOwnPropertySymbols){var o=Object.getOwnPropertySymbols(e);r&&(o=o.filter(function(r){return Object.getOwnPropertyDescriptor(e,r).enumerable;})),t.push.apply(t,o);}return t;}function configProvider_objectSpread(e){for(var r=1;r<arguments.length;r++){var t=null!=arguments[r]?arguments[r]:{};r%2?configProvider_ownKeys(Object(t),!0).forEach(function(r){_defineProperty(e,r,t[r]);}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(t)):configProvider_ownKeys(Object(t)).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(t,r));});}return e;}dayjs_min_default().locale("zh-cn");function ConfigProvider(){var props=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{};var _props$theme=props.theme,theme=_props$theme===void 0?{}:_props$theme;return/*#__PURE__*/external_react_default().createElement(external_antd_.ConfigProvider,_extends({locale:zh_CN/* default */.A,theme:configProvider_objectSpread({cssVar:true},theme)},props));}/* harmony default export */ const configProvider = (ConfigProvider);
...
var RadioGroup_excluded=["model","attr","value","onSetValue"];function RadioGroup(props){var model=props.model,attr=props.attr,propValue=props.value,onSetValue=props.onSetValue,resetProps=_objectWithoutProperties(props,RadioGroup_excluded);var _useInputGroup=useInputGroup(model,attr),value=_useInputGroup.value,getValue=_useInputGroup.getValue,itemList=_useInputGroup.itemList,getItemOpen=_useInputGroup.getItemOpen,open=_useInputGroup.open,close=_useInputGroup.close;var _onChangeRadio=function _onChangeRadio(checked,value){if(checked){open===null||open===void 0||open(value);}else{close===null||close===void 0||close(value);}var newVal=getValue();onSetValue===null||onSetValue===void 0||onSetValue(newVal);};var _onChangeGroup=function _onChangeGroup(e){var _e$target=e.target,checked=_e$target.checked,value=_e$target.value;_onChangeRadio(checked,value);};var targetValue=typeof propValue=="string"||typeof propValue=="number"?"".concat(propValue):Array.isArray(propValue)?propValue[0]:propValue;return/*#__PURE__*/external_react_default().createElement(external_antd_.Radio.Group,_extends({defaultValue:targetValue,value:targetValue,options:itemList,onChange:_onChangeGroup},resetProps));}
;// ./src/platforms/react/components/checkbox/Checkbox.tsx
function Checkbox(props){var _props$children=props.children,children=_props$children===void 0?"":_props$children,_props$checked=props.checked,checked=_props$checked===void 0?false:_props$checked,_props$disabled=props.disabled,disabled=_props$disabled===void 0?false:_props$disabled,onChange=props.onChange,_props$antProps=props.antProps,antProps=_props$antProps===void 0?{}:_props$antProps;var _onChange=function _onChange(e){var _antProps$onChange;onChange===null||onChange===void 0||onChange(e);antProps===null||antProps===void 0||(_antProps$onChange=antProps.onChange)===null||_antProps$onChange===void 0||_antProps$onChange.call(antProps,e);};return/*#__PURE__*/external_react_default().createElement(external_antd_.Checkbox,_extends({checked:checked,disabled:disabled,onChange:_onChange},antProps),children);}
;// ./src/platforms/react/components/checkbox/CheckboxGroup.tsx
function CheckboxGroup(props){var model=props.model,attr=props.attr,_props$antProps=props.antProps,antProps=_props$antProps===void 0?{}:_props$antProps,checkboxProps=props.checkboxProps,propValue=props.value,onSetValue=props.onSetValue,_props$tag=props.tag,Tag=_props$tag===void 0?(external_react_default()).Fragment:_props$tag;var _useInputGroup=useInputGroup(model,attr),getValue=_useInputGroup.getValue,itemList=_useInputGroup.itemList,open=_useInputGroup.open,close=_useInputGroup.close;var _getModelValue=function _getModelValue(){if(!propValue){return[];}return typeof propValue=="string"?[propValue]:propValue;};var _changeCheckbox=function _changeCheckbox(_ref,value){var target=_ref.target;var checked=target.checked;if(checked){open(value);}else{close(value);}var valueList=getValue();onSetValue===null||onSetValue===void 0||onSetValue(valueList);};var targetValue=_getModelValue();return/*#__PURE__*/external_react_default().createElement(Tag,antProps,itemList.map(function(_ref2){var value=_ref2.value,label=_ref2.label,disabled=_ref2.disabled;var checked=targetValue.find(function(v){return v==value;});return/*#__PURE__*/external_react_default().createElement(Checkbox,{antProps:checkboxProps,disabled:disabled,checked:checked,onChange:function onChange(e){_changeCheckbox(e,value);}},label);}));}
// EXTERNAL MODULE: ./node_modules/lodash/get.js
var get = __webpack_require__(8156);
var get_default = /*#__PURE__*/__webpack_require__.n(get);
;// ./src/platforms/react/utils/formatSelectOptions.ts
function formatSelectOptions(model,attr){var dictOption=get_default()(model.rules(),[attr,'dict'],{});var listObj=dictOption.list||{};var orderObj=dictOption.order||Object.keys(listObj);return orderObj.reduce(function(total,keyItem){var option={label:listObj[keyItem],value:keyItem};total.push(option);return total;},[]);}
;// ./src/platforms/react/components/select/Select.tsx
var Select_excluded=["model","attr","value","onSetValue","formatOptions"];function Select(props){var model=props.model,attr=props.attr,value=props.value,onSetValue=props.onSetValue,formatOptions=props.formatOptions,resetProps=_objectWithoutProperties(props,Select_excluded);function _onChange(e){onSetValue===null||onSetValue===void 0||onSetValue(e);}var dictOptions=get_default()(model.rules(),[attr,"dict"],{});var maxCount=dictOptions!==null&&dictOptions!==void 0&&dictOptions.multiple?dictOptions.max:undefined;var mode=dictOptions!==null&&dictOptions!==void 0&&dictOptions.multiple?"multiple":undefined;var _options=formatSelectOptions(model,attr);var _value=value;if(mode===undefined){_value=_options.find(function(o){return o.value==_value;});}return/*#__PURE__*/external_react_default().createElement(external_antd_.Select,_extends({allowClear:true,mode:mode,defaultValue:value,value:_value,options:_options,maxCount:maxCount,onChange:_onChange},resetProps));}
;// ./src/platforms/react/components/searchinput/SearchInput.tsx
var SearchInput_excluded=["value","onSetValue","model","attr","dp","fieldNames","paramName"];function SearchInput(props){var value=props.value,onSetValue=props.onSetValue,model=props.model,attr=props.attr,dp=props.dp,fieldNames=props.fieldNames,_props$paramName=props.paramName,paramName=_props$paramName===void 0?"keyword":_props$paramName,resetProps=_objectWithoutProperties(props,SearchInput_excluded);var data=dp.models,isLoading=dp.isLoading;var _handleChange=function _handleChange(value){onSetValue===null||onSetValue===void 0||onSetValue(value);};var _handleSearch=function _handleSearch(value){var searchParams=_defineProperty({},paramName,value);dp.setParams(searchParams);};return/*#__PURE__*/external_react_default().createElement(external_antd_.Select,_extends({showSearch:true,allowClear:true,value:value,placeholder:model.getAttributeHint(attr)||"",defaultActiveFirstOption:false,suffixIcon:null,filterOption:false,onSearch:_handleSearch,onChange:_handleChange,notFoundContent:isLoading?/*#__PURE__*/external_react_default().createElement(external_antd_.Spin,{size:"small"}):null,fieldNames:fieldNames,options:data,loading:isLoading},resetProps));}
;// ./src/platforms/react/components/datepicker/DatePicker.tsx
var DatePicker_excluded=["model","attr","value","onSetValue","format"];function DatePicker(props){var model=props.model,attr=props.attr,value=props.value,onSetValue=props.onSetValue,_props$format=props.format,format=_props$format===void 0?"YYYY-MM-DD":_props$format,reset=_objectWithoutProperties(props,DatePicker_excluded);function _onChange(dayObj){var val=dayObj.format(format);onSetValue===null||onSetValue===void 0||onSetValue(val);}var placeholder=model.getAttributeHint(attr);return/*#__PURE__*/external_react_default().createElement(external_antd_.DatePicker,_extends({format:format,defaultValue:value,placeholder:placeholder,onChange:_onChange,value:dayjs_min_default()(value)},reset));}
...
var RefIcon = /*#__PURE__*/external_react_.forwardRef(InboxOutlined_InboxOutlined);
if (false) {}
/* harmony default export */ const icons_InboxOutlined = (RefIcon);
;// ./src/platforms/react/components/uploader/uploader.tsx
var uploader_excluded=["icon","attr","model","value","onSetValue","text","hint","dragger","children","beforeUpload","maxPxSize","maxFileKBSize","mimeTypes","action","data","actionHeaders","urlPath","onError"],uploader_excluded2=["uid"];function uploader_ownKeys(e,r){var t=Object.keys(e);if(Object.getOwnPropertySymbols){var o=Object.getOwnPropertySymbols(e);r&&(o=o.filter(function(r){return Object.getOwnPropertyDescriptor(e,r).enumerable;})),t.push.apply(t,o);}return t;}function uploader_objectSpread(e){for(var r=1;r<arguments.length;r++){var t=null!=arguments[r]?arguments[r]:{};r%2?uploader_ownKeys(Object(t),!0).forEach(function(r){_defineProperty(e,r,t[r]);}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(t)):uploader_ownKeys(Object(t)).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(t,r));});}return e;}function Uploader(props){var _model$getAttributeLa;var icon=props.icon,attr=props.attr,model=props.model,value=props.value,onSetValue=props.onSetValue,text=props.text,hint=props.hint,_props$dragger=props.dragger,dragger=_props$dragger===void 0?false:_props$dragger,children=props.children,beforeUpload=props.beforeUpload,maxPxSize=props.maxPxSize,maxFileKBSize=props.maxFileKBSize,mimeTypes=props.mimeTypes,action=props.action,actionParams=props.data,actionHeaders=props.actionHeaders,urlPath=props.urlPath,onError=props.onError,reset=_objectWithoutProperties(props,uploader_excluded);var _reset$multiple=reset.multiple,multiple=_reset$multiple===void 0?true:_reset$multiple,onFileChanged=reset.onFileChanged;var _hint=hint||(model===null||model===void 0||(_model$getAttributeLa=model.getAttributeLabel)===null||_model$getAttributeLa===void 0?void 0:_model$getAttributeLa.call(model,attr));var propValue=model[attr];var _defaultFileList=getDefaultFiles(propValue);var _useFileList=useFileList(_defaultFileList,action,actionParams,actionHeaders,urlPath),fileList=_useFileList.fileList,removeFile=_useFileList.removeFile,addFile=_useFileList.addFile,clear=_useFileList.clear;function _addFile(file){_localCheck(file).then(function(){var clear=reset.multiple===false?true:false;addFile(file,clear);})["catch"](function(errmsg){onError===null||onError===void 0||onError(errmsg);});}var _localCheck=/*#__PURE__*/function(){var _ref=_asyncToGenerator(/*#__PURE__*/regenerator_default().mark(function _callee(file){var fileKb;return regenerator_default().wrap(function _callee$(_context){while(1)switch(_context.prev=_context.next){case 0:_context.prev=0;if(checkFileType(file,mimeTypes)){_context.next=3;break;}throw"文件格式错误";case 3:// 文件大小校验
...
var res=beforeUpload===null||beforeUpload===void 0?void 0:beforeUpload(file,fileList);if(res!==null&&res!==void 0&&res.then&&typeof res.then=="function"){var _res$then$catch,_res$then;(_res$then$catch=(_res$then=res.then(function(promiseResule){if(promiseResule!==false){console.log("call _addFile",promiseResule);_addFile(file);}}))["catch"])===null||_res$then$catch===void 0||_res$then$catch.call(_res$then,function(){});}else if(res===false){// 值类型
return false;}else{console.log("call _addFile res",res);_addFile(file);}}else{_addFile(file);}// 自定义上传
return false;}function _onRemove(file){removeFile(file);}// console.log(attr, "files:", fileList);
(0,external_react_.useEffect)(function(){// console.log("file list changed:", fileList);
var _fileList=action?fileList.map(function(f){return f.url;}):fileList;var targetFile=multiple?_toConsumableArray(_fileList):_fileList[0];onFileChanged===null||onFileChanged===void 0||onFileChanged(targetFile);onSetValue===null||onSetValue===void 0||onSetValue(targetFile);},[fileList]);var Fragment=dragger?external_antd_.Upload.Dragger:external_antd_.Upload;var content=dragger?/*#__PURE__*/external_react_default().createElement((external_react_default()).Fragment,null,/*#__PURE__*/external_react_default().createElement("p",{className:"ant-upload-drag-icon"},icon||/*#__PURE__*/external_react_default().createElement(icons_InboxOutlined,null)),/*#__PURE__*/external_react_default().createElement("p",{className:"ant-upload-text"},text||"点击或将文件拖拽到这里上传"),_hint&&/*#__PURE__*/external_react_default().createElement("p",{className:"ant-upload-hint"},_hint)):typeof children=="function"?children(fileList):children;return/*#__PURE__*/external_react_default().createElement(Fragment,_extends({fileList:fileList,onRemove:_onRemove,beforeUpload:_beforeUpload},reset),content);}function useFileList(){var initFileList=arguments.length>0&&arguments[0]!==undefined?arguments[0]:[];var action=arguments.length>1?arguments[1]:undefined;var actionParams=arguments.length>2&&arguments[2]!==undefined?arguments[2]:{};var actionHeaders=arguments.length>3&&arguments[3]!==undefined?arguments[3]:{};var urlPath=arguments.length>4&&arguments[4]!==undefined?arguments[4]:"";var _useState=(0,external_react_.useState)(initFileList),_useState2=_slicedToArray(_useState,2),fileList=_useState2[0],setFileList=_useState2[1];function addFile(file){var clear=arguments.length>1&&arguments[1]!==undefined?arguments[1]:false;var _olfFiles=clear?[]:fileList;setFileList([].concat(_toConsumableArray(_olfFiles),[file]));action&&uploadFile(file);}function removeFile(file){console.log("call removefile:",file);var index=fileList.indexOf(file);var newFileList=fileList.slice();newFileList.splice(index,1);setFileList(newFileList);}function clear(){setFileList([]);}function updateFile(fileInfo){setFileList(function(fileList){return fileList.map(function(file){var uid=fileInfo.uid,reset=_objectWithoutProperties(fileInfo,uploader_excluded2);if(file.uid==uid){Object.assign(file,reset);return file;}else{return file;}});});}function uploadFile(file){var formData=new FormData();formData.append(file.name,file);for(var key in actionParams){formData.append(key,actionParams[key]);}fetch(action,{method:"POST",body:formData,credentials:"include",headers:uploader_objectSpread({"x-requested-with":"XMLHttpRequest"},actionHeaders)}).then(function(resp){return resp.json();}).then(function(res){var url=get_default()(res,urlPath||"data.url[0]","");url&&updateFile({uid:file.uid,url:url,status:"success"});});}return{fileList:fileList,addFile:addFile,removeFile:removeFile,clear:clear,uploadFile:uploadFile};}function checkFileType(file,mimeTypes){// console.log({ file, mimeTypes });
if(mimeTypes&&mimeTypes.length>0){return mimeTypes.indexOf(file.type)>-1;}return true;}function checkFilePxSize(file,width,height){return new Promise(function(resolve,reject){var img=new Image();img.onload=function(){if(img.width>width||img.height>height){reject("图像尺寸过大");}else{resolve(true);}};img.onerror=function(e){reject("图像加载失败");};img.src=URL.createObjectURL(file);});}function getDefaultFiles(value){if(!value){return[];}if(typeof value=="string"&&value.length>0){return[{url:value,name:value}];}// array
if(value.length>0&&value[0].url){return value;}return[];}/* harmony default export */ const uploader = (Uploader);
;// ./src/platforms/react/components/segmented/Segmented.tsx
var Segmented_excluded=["model","attr","value","onSetValue"];function Segmented(props){var model=props.model,attr=props.attr,propValue=props.value,onSetValue=props.onSetValue,resetProps=_objectWithoutProperties(props,Segmented_excluded);var itemList=formatSelectOptions(model,attr);function _onChange(val){onSetValue===null||onSetValue===void 0||onSetValue(val);}return/*#__PURE__*/external_react_default().createElement(external_antd_.Segmented,_extends({defaultValue:propValue,value:propValue,options:itemList,onChange:_onChange},resetProps));}
