...
model===null||model===void 0||(_model$validate=model.validate)===null||_model$validate===void 0||_model$validate.call(model);onSubmit===null||onSubmit===void 0||onSubmit(data,model.getFirstError());updateView();}return/*#__PURE__*/external_react_default().createElement(contexts_FormContext.Provider,{value:{getValue:getValue,setValue:setValue,updateView:updateView,model:model}},/*#__PURE__*/external_react_default().createElement(external_antd_.Form,_extends({className:classnames_default()(form_module_1,className,inline&&"inline"),onFinish:_onFinish},reset),props.children));}
