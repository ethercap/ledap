...
var Form_excluded=["model","className","inline"];function Form(props){var model=props.model,className=props.className,inline=props.inline,reset=_objectWithoutProperties(props,Form_excluded);var _useState=(0,external_react_.useState)(false),_useState2=_slicedToArray(_useState,2),bool=_useState2[0],setBool=_useState2[1];function getValue(attr){return model[attr];}function setValue(attr,val){model[attr]=val;setBool(function(bool){return!bool;});}function updateView(){setBool(function(bool){return!bool;});}return/*#__PURE__*/external_react_default().createElement(contexts_FormContext.Provider,{value:{getValue:getValue,setValue:setValue,updateView:updateView,model:model}},/*#__PURE__*/external_react_default().createElement(external_antd_.Form,_extends({className:classnames_default()(form_module_1,className,inline&&"inline")},reset),props.children));}
...
function ownKeys(e,r){var t=Object.keys(e);if(Object.getOwnPropertySymbols){var o=Object.getOwnPropertySymbols(e);r&&(o=o.filter(function(r){return Object.getOwnPropertyDescriptor(e,r).enumerable;})),t.push.apply(t,o);}return t;}function _objectSpread(e){for(var r=1;r<arguments.length;r++){var t=null!=arguments[r]?arguments[r]:{};r%2?ownKeys(Object(t),!0).forEach(function(r){_defineProperty(e,r,t[r]);}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(t)):ownKeys(Object(t)).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(t,r));});}return e;}dayjs_min_default().locale("zh-cn");function ConfigProvider(){var props=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{};var _props$theme=props.theme,theme=_props$theme===void 0?{}:_props$theme;return/*#__PURE__*/external_react_default().createElement(external_antd_.ConfigProvider,_extends({locale:zh_CN/* default */.A,theme:_objectSpread({cssVar:true},theme)},props));}/* harmony default export */ const configProvider = (ConfigProvider);
...
var uploader_excluded=["icon","attr","model","value","onSetValue","text","hint","dragger","children","defaultFileList","beforeUpload","maxPxSize","maxFileKBSize","mimeTypes"];function Uploader(props){var _model$getAttributeLa;var icon=props.icon,attr=props.attr,model=props.model,value=props.value,onSetValue=props.onSetValue,text=props.text,hint=props.hint,_props$dragger=props.dragger,dragger=_props$dragger===void 0?false:_props$dragger,children=props.children,defaultFileList=props.defaultFileList,beforeUpload=props.beforeUpload,maxPxSize=props.maxPxSize,maxFileKBSize=props.maxFileKBSize,mimeTypes=props.mimeTypes,reset=_objectWithoutProperties(props,uploader_excluded);var _reset$multiple=reset.multiple,multiple=_reset$multiple===void 0?true:_reset$multiple,onChange=reset.onChange;var _hint=hint||(model===null||model===void 0||(_model$getAttributeLa=model.getAttributeLabel)===null||_model$getAttributeLa===void 0?void 0:_model$getAttributeLa.call(model,attr));var _useFileList=useFileList(defaultFileList),fileList=_useFileList.fileList,removeFile=_useFileList.removeFile,addFile=_useFileList.addFile,clear=_useFileList.clear;function _addFile(file){_localCheck(file).then(function(){var clear=reset.multiple===false?true:false;addFile(file,clear);})["catch"](function(e){console.warn("\u6587\u4EF6\u6821\u9A8C\u672A\u901A\u8FC7\uFF1A",e);});}var _localCheck=/*#__PURE__*/function(){var _ref=_asyncToGenerator(/*#__PURE__*/regenerator_default().mark(function _callee(file){var fileKb;return regenerator_default().wrap(function _callee$(_context){while(1)switch(_context.prev=_context.next){case 0:_context.prev=0;if(checkFileType(file,mimeTypes)){_context.next=3;break;}throw"file type failed";case 3:// 文件大小校验
fileKb=file.size/1024;if(!(maxFileKBSize&&fileKb>maxFileKBSize)){_context.next=6;break;}throw"file size failed";case 6:if(!maxPxSize){_context.next=10;break;}_context.next=9;return checkFilePxSize(file,maxPxSize.width,maxPxSize.height);case 9:return _context.abrupt("return",_context.sent);case 10:return _context.abrupt("return",Promise.resolve(true));case 13:_context.prev=13;_context.t0=_context["catch"](0);return _context.abrupt("return",Promise.reject(_context.t0));case 16:case"end":return _context.stop();}},_callee,null,[[0,13]]);}));return function _localCheck(_x){return _ref.apply(this,arguments);};}();function _beforeUpload(file){if(typeof beforeUpload==="function"){// 业务校验
...
return false;}function _onRemove(file){removeFile(file);}console.log(attr,"files:",fileList);(0,external_react_.useEffect)(function(){var val=multiple?_toConsumableArray(fileList):fileList[0];onChange===null||onChange===void 0||onChange(val);onSetValue===null||onSetValue===void 0||onSetValue(val);},[fileList]);var Fragment=dragger?external_antd_.Upload.Dragger:external_antd_.Upload;var content=dragger?/*#__PURE__*/external_react_default().createElement((external_react_default()).Fragment,null,/*#__PURE__*/external_react_default().createElement("p",{className:"ant-upload-drag-icon"},icon||/*#__PURE__*/external_react_default().createElement(icons_InboxOutlined,null)),/*#__PURE__*/external_react_default().createElement("p",{className:"ant-upload-text"},text||"点击或将文件拖拽到这里上传"),_hint&&/*#__PURE__*/external_react_default().createElement("p",{className:"ant-upload-hint"},_hint)):typeof children=="function"?children(fileList):children;return/*#__PURE__*/external_react_default().createElement(Fragment,_extends({fileList:fileList,onRemove:_onRemove,beforeUpload:_beforeUpload},reset),content);}function useFileList(){var initFileList=arguments.length>0&&arguments[0]!==undefined?arguments[0]:[];var _useState=(0,external_react_.useState)(initFileList),_useState2=_slicedToArray(_useState,2),fileList=_useState2[0],setFileList=_useState2[1];function addFile(file){var clear=arguments.length>1&&arguments[1]!==undefined?arguments[1]:false;var _olfFiles=clear?[]:fileList;setFileList([].concat(_toConsumableArray(_olfFiles),[file]));}function removeFile(file){console.log("call removefile:",file);var index=fileList.indexOf(file);var newFileList=fileList.slice();newFileList.splice(index,1);setFileList(newFileList);}function clear(){setFileList([]);}return{fileList:fileList,addFile:addFile,removeFile:removeFile,clear:clear};}function checkFileType(file,mimeTypes){console.log({file:file,mimeTypes:mimeTypes});if(mimeTypes&&mimeTypes.length>0){return mimeTypes.indexOf(file.type)>-1;}return true;}function checkFilePxSize(file,width,height){return new Promise(function(resolve,reject){var img=new Image();img.onload=function(){if(img.width>width||img.height>height){console.warn("文件尺寸过大",{imgWidth:img.width,imgHeight:img.height});reject(false);}else{resolve(true);}};img.onerror=function(e){console.warn("load img error",e);reject(null);};img.src=URL.createObjectURL(file);});}/* harmony default export */ const uploader = (Uploader);
