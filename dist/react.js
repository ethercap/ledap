...
dayjs_min_default().locale("zh-cn");function ConfigProvider(){var props=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{};return/*#__PURE__*/external_react_default().createElement(external_antd_.ConfigProvider,_extends({locale:zh_CN/* default */.A,theme:{cssVar:true}},props));}/* harmony default export */ const configProvider = (ConfigProvider);
