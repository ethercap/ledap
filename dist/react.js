...
var RangeDatePicker_excluded=["model","attr","value","onSetValue","format","onBlur","dp","validate"];function RangeDatePicker(props){var model=props.model,attr=props.attr,value=props.value,onSetValue=props.onSetValue,_props$format=props.format,format=_props$format===void 0?"YYYY-MM-DD":_props$format,onBlur=props.onBlur,dp=props.dp,validate=props.validate,reset=_objectWithoutProperties(props,RangeDatePicker_excluded);function _onChange(_val){var val=!_val?[]:getRangeDataValue(_val);onSetValue===null||onSetValue===void 0||onSetValue(val);}var placeholder=model.getAttributeHint(attr);var _value=getRangeDataValue(value);return/*#__PURE__*/external_react_namespaceObject["default"].createElement(external_antd_namespaceObject.DatePicker.RangePicker,_extends({format:format,defaultValue:_value,placeholder:placeholder,onChange:_onChange,value:_value},reset));}
