...
var TagList_excluded=["model","attr","value","onSetValue","useSort","useAdd","closable","addText","inputType"];function TagList(props){var model=props.model,attr=props.attr,value=props.value,onSetValue=props.onSetValue,_props$useSort=props.useSort,useSort=_props$useSort===void 0?false:_props$useSort,_props$useAdd=props.useAdd,useAdd=_props$useAdd===void 0?true:_props$useAdd,_props$closable=props.closable,closable=_props$closable===void 0?true:_props$closable,_props$addText=props.addText,addText=_props$addText===void 0?"添加":_props$addText,_props$inputType=props.inputType,inputType=_props$inputType===void 0?"number":_props$inputType,resetProps=_objectWithoutProperties(props,TagList_excluded);var _useState=(0,external_react_namespaceObject.useState)(false),_useState2=_slicedToArray(_useState,2),inputVisible=_useState2[0],setInputVisible=_useState2[1];var _useState3=(0,external_react_namespaceObject.useState)(""),_useState4=_slicedToArray(_useState3,2),inputValue=_useState4[0],setInputValue=_useState4[1];var inputRef=(0,external_react_namespaceObject.useRef)(null);var _value=typeof value==="string"?[value]:Array.isArray(value)?value:[];var showInput=function showInput(){setInputVisible(true);};var handleInputChange=function handleInputChange(e){setInputValue(e.target.value);};var handleInputConfirm=function handleInputConfirm(){if(inputValue&&!_value.includes(inputValue)){var newValue=[].concat(_toConsumableArray(_value),[inputValue]);onSetValue(newValue);}setInputVisible(false);setInputValue("");};var AddFragment=useAdd?inputVisible?/*#__PURE__*/external_react_namespaceObject["default"].createElement(external_antd_namespaceObject.Input,{ref:inputRef,type:inputType,size:"small",style:{width:140,height:22,marginInlineEnd:8,verticalAlign:"top"},value:inputValue,onChange:handleInputChange,onBlur:handleInputConfirm,onPressEnter:handleInputConfirm}):/*#__PURE__*/external_react_namespaceObject["default"].createElement(external_antd_namespaceObject.Tag,{style:{height:22,borderStyle:"dashed"},icon:/*#__PURE__*/external_react_namespaceObject["default"].createElement(icons_PlusOutlined,null),onClick:showInput},addText):null;return/*#__PURE__*/external_react_namespaceObject["default"].createElement(external_antd_namespaceObject.Space,{gap:4,wrap:true},_value.map(function(item,index){return/*#__PURE__*/external_react_namespaceObject["default"].createElement(external_antd_namespaceObject.Tag,{key:index,closable:true,onClose:function onClose(e){var newValue=_toConsumableArray(_value);newValue.splice(index,1);onSetValue===null||onSetValue===void 0||onSetValue(newValue);}},item);}),AddFragment);}
