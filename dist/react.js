...
onSetValue===null||onSetValue===void 0||onSetValue(value);};// useEffect(() => {
//   console.log("search input loaded", { dp, attr, value, model });
//   if (dp && attr && value) {
//     dp.setParams({ [attr]: value });
//   }
// }, [dp]);
var _handleSearch=function _handleSearch(value){var searchParams=_defineProperty({},paramName,value);dp.setParams(searchParams);};var _options=data;var _value=value;// const { label: _showLabel = "name", value: _showValue = "id" } = fieldNames;
